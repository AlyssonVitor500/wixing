    ...
    <div id="conteudo"  style="height: 100vh; padding-bottom: 5vh;" class="container">
        <div class="container text-center mt-5">
            ...
            <div class="row text-center mt-5">
                <div class="col-md-6">
                    <a href="config.php" style="font-weight: bold" id="n" class="btn btn-lg"><i class="fas fa-undo"></i> Não, desejo retornar!</a>
                </div>
                <div class="col-md-6">
                    <a href="_sqlC/deleteUserN.php"  style="font-weight: bold" id="s" class="btn btn-lg">Sim! Estou ciente e quero continuar <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
