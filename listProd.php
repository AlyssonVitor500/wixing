    ...
    <div id="conteudo"  style="height: 100vh; padding-bottom: 5vh;" class="container">
        <div class="row">
            <div class="col-md-12 text-center mt-2">
                <h1><strong><i class="fas fa-box-open"></i> Listagem de Produtos </strong><button data-toggle="modal" data-target="#FornSearchAll" data- class="btn ml-5" style="background-color: #480720; color: white"><strong>Pesquisar por Fornecedor</strong></button> </h1>
            </div>
        </div>
    ...
    <div class="modal fade" id="FornSearchAll" tabindex="-1" role="dialog" aria-labelledby="FornSearch" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body text-center">
                <div class="row">
                    <div class="col-md-12">
                        <form action="listProdEspec.php" method="get">
