    ...
    <div id="conteudo"  style="height: 100vh; padding-bottom: 5vh;" class="container">
        ...
        <div class="row">
            <div class="col-md-12 text-center mt-2">
                <h1><strong><i class="fas fa-user-friends"></i> Listagem de Usuários</strong> <button data-toggle="modal" data-target="#UserSearch" data- class="btn ml-5" style="background-color: #480720; color: white"><strong>Pesquisar por Tipo de Usuário</strong></button>  <a href="listUsers.php" style="background-color:#041042; color: white" class="btn"><strong>Todos as Contas</strong></a></h1>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <table style="cursor: default" class="table  table-hover table-light">
                    ...
                    <tbody style="font-weight: bold" class="text-center">
                        <?php
                            include_once '_sqlC/listUserEspec.php';
                        ?>
                    </tbody>
                </table>
            </div>
